...
public class EmployeeServiceImpl implements IEmployeeService {
	...
	public String registerEmployee(EmployeeDTO dto) throws Exception {
		...
		count = dao.insert(bo);
		if (count == 1)
			return "Employee Registration Done::->" + " BasicSalary:" + dto.getBasicSal() + " GrossSalary:" + gross + " Netsalary:" + netpay;
		else
			return "Employee Registration Failed::->" + " BasicSalary:" + dto.getBasicSal() + " GrossSalary:" + gross	+ " Netsalary:" + netpay;
	}
}
